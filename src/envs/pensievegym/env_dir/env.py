...
A_DIM = 6   # Discrete Action space
S_INFO = 6
S_LEN = 8

S_DIM = S_INFO * S_LEN   # Uses recurrent structure

COOKED_TRACE_FOLDER = "/newhome/cooked_traces/"
...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, random_seed=RANDOM_SEED):
        ...
        for bitrate in range(BITRATE_LEVELS):
            self.video_size[bitrate] = video_size[bitrate]
